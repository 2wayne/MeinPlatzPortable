DEVELOPER: Replace the three occurrences of MeinPlatzPortable in this file
...
user in an INI file next to MeinPlatzPortable.exe called MeinPlatzPortable.ini.
...
copy AppNamePortable.ini from this directory to MeinPlatzPortable.ini next to
MeinPlatzPortable.exe. The options in the INI file are as follows:
